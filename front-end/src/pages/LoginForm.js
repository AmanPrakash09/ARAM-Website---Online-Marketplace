...
const LoginForm = () => {
  ...
  const google = () => {
    window.open("http://marketplace.a-ramcreatives.com/auth/google", "_self")
  }

  const github = () => {
    window.open("http://marketplace.a-ramcreatives.com/auth/github", "_self")
  }

  const facebook = () => {
    window.open("http://marketplace.a-ramcreatives.com/auth/facebook", "_self")
  }
