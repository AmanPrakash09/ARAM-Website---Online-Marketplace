...
const LoginForm = () => {
  ...
  const google = () => {
    window.open("http://18.216.190.205:5000/auth/google", "_self")
  }

  const github = () => {
    window.open("http://18.216.190.205:5000/auth/github", "_self")
  }

  const facebook = () => {
    window.open("http://18.216.190.205:5000/auth/facebook", "_self")
  }
